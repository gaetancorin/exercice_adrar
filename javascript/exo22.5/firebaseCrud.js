...
addUserButton.addEventListener("click", addBtnClicked());

function addBtnClicked(){
  let addUserInputsUI = document.getElementsByClassName('user-input');
  let newUser = {};
  // addUserInputsUI.forEach((element, i) =>{
  //   key = addUserInputsUI[i].getAttribute('data-key');
  //   value =  addUserInputsUI[I].value;
  //   // Pour chaque clé (âge, name, email) on l’associe à notre nouvel utilisateur 
  //   newUser[key] = value;
  // })
