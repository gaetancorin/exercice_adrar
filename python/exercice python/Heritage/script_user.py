...
info_user = []
banque =  Banque()
#   creer un objet banque 
#  enrengistre util dans liste banque 
# quand quelqu'un emprunte je deduit le montant de capital de ma banque 
...
while True :
    ...
    if demande == "o":
        ...
        if choix == 1:
            ...
            banque.info_user.append(mon_user)
